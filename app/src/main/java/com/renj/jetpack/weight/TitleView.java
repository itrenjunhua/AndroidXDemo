...
public class TitleView extends RelativeLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        titleTextSize = typedArray.getDimension(R.styleable.TitleView_title_view_titleSize, UIUtils.sp2px(18));
        titleTextColor = typedArray.getColor(R.styleable.TitleView_title_view_titleColor, resources.getColor(R.color.text_main));

        rightText = typedArray.getString(R.styleable.TitleView_title_view_right_text);
        rightTextSize = typedArray.getDimension(R.styleable.TitleView_title_view_right_textSize, UIUtils.sp2px(16));
        rightTextColor = typedArray.getColor(R.styleable.TitleView_title_view_right_textColor, resources.getColor(R.color.text_grey));
        ...
        bottomLineColor = typedArray.getColor(R.styleable.TitleView_title_view_bottom_line_color, resources.getColor(R.color.grey));
        typedArray.recycle();
    }
